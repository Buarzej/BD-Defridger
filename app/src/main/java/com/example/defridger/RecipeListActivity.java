...
public class RecipeListActivity extends AppCompatActivity {
    ...
    private void addNewRecipes(Context context) {
        new Thread(() -> {
            ...
            if (recipesData.isEmpty()) {
                ...
                RecipeListActivity.this.runOnUiThread(() -> {
    ...
    private byte[] getRecipeImage(int id, String imageType) {
        ...
        String imageUrl = RECIPE_IMAGE_BASE_URL + id + "-240x150." + imageType;
        try {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backButton.setOnClickListener(view -> RecipeListActivity.this.finish());
